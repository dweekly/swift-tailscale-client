...
- Floor: **60%** at v0.4.0 (the untested `UnixSocketTransport` and `MacClientInfo` drag the total until their v0.5.0 parser extraction), ratcheting to **75%** once those land and **85%** by v1.0.
