...
creates-and-switches to an empty profile (follow with a login),
``TailscaleClient/switchProfile(_:)`` changes the active identity, and
``TailscaleClient/deleteProfile(_:)`` removes one.
...
- ``TailscaleClient/start(options:)``
- ``TailscaleClient/profiles()``
- ``TailscaleClient/currentProfile()``
- ``TailscaleClient/switchProfile(_:)``
- ``TailscaleClient/switchToEmptyProfile()``
- ``TailscaleClient/deleteProfile(_:)``
- ``LoginProfile``
- ``NetworkProfile``
