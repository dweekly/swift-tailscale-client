...
From 1.0 onward they follow SemVer strictly.

Stability here also means *tolerant decoding*: models default missing
fields, ignore unknown ones, and preserve arbitrary capability
values and ServeConfig structures losslessly — a daemon upgrade should never make `status()` start
throwing.
